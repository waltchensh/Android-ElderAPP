...
<div aligh=center> 於2019/09 - 2020/01期間，修讀中原大學 - SA 系統分析與設計課程，課程與銀髮族協會合作，需設計幫助銀髮族聚會的APP，希望透過設計簡單易用的APP，讓銀髮族可以查看活動並報名參加，以增進生活樂趣，獲勝組別將與銀髮族協會合作。</div>
...
* 個人第一個 Android APP，並未有專業的命名、程式碼排版、介面設計，但所有學習皆是透過Google大神，在此之前僅有 JAVA 基礎但未曾使用過 Android Studio。
