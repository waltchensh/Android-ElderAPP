...
public class m_home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        icon1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                intent.setClass(m_home.this , m_GetMoney.class);
        ...
        icon2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(m_home.this , m_activity_pages.class);
                startActivity(intent);
        ...
        icon5.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(m_home.this , m_shop_pages.class);
                startActivity(intent);
        ...
        to_show_record.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(m_home.this, ShowRecord.class);
                startActivity(intent);
            }
        });
...
//                startActivity(intent);
        ...
        btnlogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(m_home.this);
                ...
                builder.setMessage("確定登出?")
                        .setPositiveButton("確定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intToMain = new Intent(m_home.this, LoginActivity.class);
