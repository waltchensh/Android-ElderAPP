...
public class c_Join_Record extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c_join_record);
        ...
        dateButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(c_Join_Record.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    protected void onStart() {
        ...
        databasejoined.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                record_ArtistList adapter = new record_ArtistList(c_Join_Record.this ,artistList);
    ...
    private void addArtist(){
        ...
        if (!TextUtils.isEmpty(name)){
            ...
            databasejoined.child(id).setValue(artist);
